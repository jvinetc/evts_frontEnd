      ...
      <Container fluid>
        ...
        <Navbar.Collapse id="navbarResponsive">
          ...
          <Nav className="w-100 d-flex justify-content-around">
            ...
            <div className="vr mx-2" />
            <Nav.Link as={Link} to={usuario.Role.name ==='admin'?'/stops': usuario.Sells.length === 0  ?'/profile':"/stops"} className="text-center d-flex flex-column align-items-center">
              <SignStop size={24} className={`icon-nav ${activeTab === "stops" ? "active" : ""}`}
                onClick={() =>usuario.Role.name ==='admin'?setActiveTab("stops"):usuario.Sells.length === 0 ?alert('Primero debes crear una tienda') : setActiveTab("stops")} />
